function getEnTranslation(id) {
    switch (id) {
        ...
        case 72:
            return "Every building which is tinted blue has uncompleted riddles. If you crack their code they appear green. You can find the questions by clicking on the according button. Most of the time you have got to enter a word, number or code in order to solve the riddle. The next question will apeear automaticly after your answer is right."
        case 73:
            return "Have fun!"
        case 74:
            return "Let's GO!"
